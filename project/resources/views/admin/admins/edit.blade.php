...
<section class="py-10">
    <div class="container mx-auto px-4">
        <h1 class="text-2xl font-bold text-white mb-6">Редактировать администратора: {{ $user->name }}</h1>
        ...
        <div class="bg-[#3C3C3C] rounded-xl shadow-lg p-6">
            <form action="{{ route('admin.admins.update', $user) }}" method="POST">
                ...
                <div>
                    <label for="password" class="block text-sm font-medium text-gray-400 mb-2">Новый пароль (необязательно)</label>
                ...
                <div>
                    <label for="password_confirmation" class="block text-sm font-medium text-gray-400 mb-2">Подтвердите новый пароль</label>
